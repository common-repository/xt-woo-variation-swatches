...
class XT_Woo_Variation_Swatches_Admin_Product {
    ...
    public function __construct( &$core ) {
        ...
        add_filter(
            ...
            array($this, 'product_swatches_data_tab'),
            99,
            1
        );
    ...
    function enqueue_product_ajax_save_script() {
        ...
        if ( $post->post_type == 'product' ) {
            ...
            wp_enqueue_script(
                ...
                $this->core->plugin_url( 'admin' ) . 'assets/js/product-edit' . XTFW_SCRIPT_SUFFIX . '.js',
                array('jquery'),
